...
AbstractQuickPanel {
    ...
    // Toggles
    readonly property list<string> availableToggleTypes: ["network", "bluetooth", "idleInhibitor", "easyEffects", "nightLight", "darkMode", "brightness", "cloudflareWarp", "gameMode", "screenSnip", "colorPicker", "onScreenKeyboard", "mic", "audio", "notifications", "powerProfile","musicRecognition", "antiFlashbang"]
                ...
                delegate: ButtonGroup {
                    ...
                    Repeater {
                        ...
                        delegate: AndroidToggleDelegateChooser {
                            ...
                            onOpenBrightnessDialog: root.openBrightnessDialog()
